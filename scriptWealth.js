document.addEventListener("DOMContentLoaded", function () {
    var buttonsData = [
        { label: "Opportunity to reset \n重置的机会", link: "wealths/wealth1.png" },
        { label: "Self Correction \n自我修正", link: "wealths/wealth2.png" },
        { label: "Peak of Life \n人生高峰", link: "wealths/wealth3.png" },
        { label: "Enjoying \n享受", link: "wealths/wealth4.png" },
        { label: "Me Time \n自己的时刻", link: "wealths/wealth5.png" },
        { label: "Traveling \n环游世界", link: "wealths/wealth6.png" }
    ];
    ...
    buttonsData.forEach(function (buttonInfo) {
        ...
        button.addEventListener("click", function () {
            ...
            window.location.href = "wealth-1.html";
        });
